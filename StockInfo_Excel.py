        ...
        for i in range(1, len(srlists) - 1):
            if(srlists[i].span != None):
                ...
                if(compare_yesterday != None):
                    ...
                    if(inc_price == "http://imgstock.naver.com/images/images4/ico_down.gif"):
                        variation = '-' + non_marking
                    elif(inc_price == "http://imgstock.naver.com/images/images4/ico_up.gif"
                         or inc_price == "http://imgstock.naver.com/images/images4/ico_up02.gif"):
                        variation = '+' + non_marking
                else:
