...
#시각화함수
def visualization(start,end,mat): 
    df=pd.read_excel('C:/Users/user/Desktop/all_stock.xlsx')
    df = df[df.날짜 <=end]
    df= df [df.날짜>=start]
    date=df['날짜'].tolist()
    df.index = df['날짜']
    ...
    plt.plot(view.index,view,label=mat)
...
if __name__ == "__main__":
	...
	corr('C:/Users/kupis/Desktop/all_stock.xlsx',start,end)
	mat=clustering('C:/Users/kupis/Desktop/150x150.xlsx',1.5,corr)
	view=visualization(start,end,mat)
