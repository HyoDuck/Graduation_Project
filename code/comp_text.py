...
def compress_keywords_list(keylist):
    file_num = 0
...
def read_exl(dir_path):
    ...
    return person_result, org_result, place_result, product_result, chr_result, brand_result, hobby_result, psycology_result

def extract_keyword(dir_path, return_num = 3):
    person_result = []
    org_result = []
    place_result = []
    product_result = []
    ...
    person_result, org_result, place_result, product_result, chr_result, brand_result, hobby_result, psycology_result = read_exl(dir_path=dir_path)

    person_result = compress_keywords_list(person_result)
    org_result = compress_keywords_list(org_result)
    place_result = compress_keywords_list(place_result)
    chr_result = compress_keywords_list(chr_result)
    brand_result = compress_keywords_list(brand_result)
    hobby_result = compress_keywords_list(hobby_result)
    psycology_result = compress_keywords_list(psycology_result)
    ...
    return person_result[:return_num], org_result[:return_num], place_result[:return_num],\
           product_result[:return_num], chr_result[:return_num], brand_result[:return_num],\
           hobby_result[:return_num], psycology_result[:return_num]
